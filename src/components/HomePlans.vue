    ...
    <v-container grid-list-lg>
        ...
        <v-layout row wrap>
            <v-flex xs12 sm12 md4>
                <v-card>
                    ...
                    <v-card-title primary-title>
                        <div>
                            <h3 class="headline mb-0">Medium</h3>
                            <div>
            ...
            <v-flex xs12 sm12 md4>
                <v-card>
                    <v-img
                        src="https://pirate.black/wp-content/uploads/2019/04/Pirate_Logo_Ship_Black.png"
                        height="500px"
                    >
                        <v-container fill-height fluid>
                            <v-layout fill-height>
            ...
            <v-flex xs12 sm12 md4>
                <v-card>
                    <v-img
                        src="https://i.pinimg.com/originals/ba/66/2b/ba662b6ccdda378d1a6924d7326e64d4.png"
                        height="500px"
                    >
                        <v-container fill-height fluid>
                            <v-layout fill-height>
                    ...
                    <v-card-title primary-title>
                        <div>
                            <h3 class="headline mb-0">Custom</h3>
                            <div>
                                Lorem ipsum dolor sit amet, consectetur
                                adipiscing elit. Nullam mauris felis, varius
                                rutrum massa a, dignissim ornare dui. Cras eget
